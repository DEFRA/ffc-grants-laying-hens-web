...
const desirabilityQuestionsHen = ['poultry-type', 'current-system', 'current-multi-tier-system', 'ramp-connection', 'maximum-tier-height', 'tier-number', 'hen-multi-tier', 'natural-light', 'easy-grip-perches', 'building-biosecurity', 'pollution-mitigation', 'renewable-energy', 'bird-data-type', 'environmental-data-type']
const desirbailityQuestionsPullet = ['poultry-type', 'current-system', 'current-multi-tier-system', 'ramp-connection', 'maximum-tier-height', 'tier-number', 'pullet-multi-tier', 'natural-light', 'dark-brooders', 'easy-grip-perches', 'building-biosecurity', 'pollution-mitigation', 'pullet-veranda-features', 'renewable-energy', 'bird-data-type', 'environmental-data-type']
