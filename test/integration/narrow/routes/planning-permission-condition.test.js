...
describe('Page: /planning-permission-condition', () => {
  ...
  it('should load the condition page with correct heading', async () => {
    ...
    expect(getResponse.payload).toContain('You must have secured planning permission before you submit a full application. The application deadline is 30 January 2026.')
  })
