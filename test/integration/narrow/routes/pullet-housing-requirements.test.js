...
describe('Page: /pullet-housing-requirements', () => {
  ...
  it('page loads successfully, with all the options', async () => {
    ...
    expect(response.payload).toContain('a useable area at multiple bird-accessible heights from 10 days of age')
  ...
  it('user selects ineligible option `No` -> display ineligible page', async () => {
    ...
    expect(postResponse.payload).toContain('a useable area at multiple bird-accessible heights from 10 days of age')
