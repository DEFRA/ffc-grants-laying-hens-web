...
describe('confirm page', () => {
  ...
  it('page loads successfully, with all the options', async () => {
    ...
    expect(response.payload).toContain('RPA will be in touch when the full application period opens to tell you if your project is invited to submit a full application. This will include an initial assessment of the ambient environment.')
  })
})
