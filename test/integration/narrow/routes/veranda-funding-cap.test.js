...
describe('Page: /veranda-funding-cap', () => {
  ...
  it('should load the condition page with correct heading', async () => {
    ...
    expect(response.payload).toContain('Alternatively, you can check if you are eligible for comprehensive grant funding to refurbish or replace laying hen or pullet housing.')
  })
